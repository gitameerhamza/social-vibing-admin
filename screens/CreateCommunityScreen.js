  ...
  const confirmCreate = async () => {
    ...
    try {
      ...
      if (image) {
        ...
        profileImageUrl = profileRes.secure_url || profileRes.url;
      }
      ...
      if (coverImage) {
        ...
        coverImageUrl = coverRes.secure_url || coverRes.url;
      }
      ...
      if (background) {
        ...
        backgroundImageUrl = bgRes.secure_url || bgRes.url;
      }
      ...
      Alert.alert(
        ...
        [
          { text: "OK", onPress: () => navigation.navigate('AdminPortal') }
        ]
      );
